...
## Installer Package – Version 1.0.1-0.5

> please make sure to star the repo. thank you :)

**Installer File:**
`BubblesTheDev Web Browser_Installer_1.0.1-0.5`
> Security Updates
...
## 📥 Version 1.0.1-0.5 Downloads

[Version 1.0.1-0.5](https://github.com/KernFerm/BubblesTheDev-WebBrowser/releases/download/V10105-SecurityUpdates-BubblesTheDev-Web-Browser_Installer/BubblesTheDev.Web.Browser_Installer_1.0.1-0.5.exe)

[Download Version 1.0.1-0.5](https://github.com/KernFerm/BubblesTheDev-WebBrowser/releases/tag/V10105-SecurityUpdates-BubblesTheDev-Web-Browser_Installer)
...
1. Double-click:
   ...
   ```
   BubblesTheDev Web Browser_Installer_1.0.1-0.5.exe
   ```
...
If you already have an older version installed, open `Start > Settings > Apps`, find `BubblesTheDev Web Browser`, uninstall the older version, and then install version `1.0.1-0.5`.
