...
Version `1.1.33` is the starting baseline for future 5-tab performance comparisons in this project.
...
- Version-to-version performance tracking should move forward from `1.1.33`
...
Build `1.1.33` includes performance-related behavior intended to improve longer browsing sessions, including:
...
This report now treats version `1.1.33` as the first clean automated reference point for future comparisons.

When newer versions are tested, their results should be compared against the automated `1.1.33` baseline rather than older manual notes.
