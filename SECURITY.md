...
Current security-sensitive design points in version `1.1.32` include:
...
* updated bundled `ffmpeg.exe` and `ffprobe.exe` handling with pinned SHA-256 verification before use
