...
- Version `1.2.40` is the current release.
- Older versions are not supported for current fixes and improvements.

Current documentation highlights for this release:

- the current release is a bug-fix and reliability update focused on `12` fixes across AI, diagnostics, updates, renderer safety, and settings behavior
...
- the browser keeps its current local-first privacy and security posture without a new headline browser feature
