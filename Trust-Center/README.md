...
The `trust-center` folder exists to help people understand how **BubblesTheDev Web Browser** works without requiring them to read private implementation details or reverse-engineer the full application.

These transparency files are meant to be useful for:
...
The trust-center files are based on the browser behavior described in the repository documentation, including:
...
That means the trust-center files focus on ideas such as:
...
The trust-center files intentionally do **not** publish real secrets, real servers, real update systems, or real user information.

## Accessibility Impact

The trust-center files are written in plain English first and technical English second.
...
1. Open the trust center to understand the browser in plain language.
2. Compare the trust-center files with the public docs in `docs/`.
